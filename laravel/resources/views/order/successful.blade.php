...
<section>
    <a style="color: black;" href="/order/tracker/{{ $order->key }}">
        <button type="button" class="button-main">Відстежити статус замовлення</button>
    </a>
    <a style="color: black;" href="/"><button type="button" class="button-main">Продовжити покупки</button></a>
</section>
<section>
    <ul>
